...
| `P1` | `#104` GPU throughput follow-up hot path | In Progress | `H-001`은 canonical 4-run 기준 회귀로 롤백했고, `H-003`은 이제 `data.py` / `engine.py` live path에 다시 구현됨 | `H-003` canonical remeasure 후 다음 slice 여부 결정 | [doc](todos/2026_03_13-issue104-gpu-throughput-followup-hotpath.md) |
