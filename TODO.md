...
| `#67 Runtime PIT candidate policy` | Open | GPU runtime gate parity, CPU opt-in strict frozen manifest, candidate order direct validation artifact, PIT failure/log standardization까지 반영됨. 남은 핵심은 live evidence 연결 | [#67](todos/2026_02_09-issue67-tier-universe-migration.md) |
...
| --- | --- | --- | --- | --- | --- |
| `P0` | `#67` PIT universe + DailyStockTier runtime 정렬 | In Progress | GPU preload gate, CPU opt-in strict frozen manifest, candidate order direct validation artifact, PIT failure/log standardization까지 맞췄다. 남은 핵심은 live evidence 연결이다 | candidate order live evidence run + parity/certification runbook 연결 | [doc](todos/2026_02_09-issue67-tier-universe-migration.md) |
