...
class TestDbSetup(unittest.TestCase):
    def test_create_tables_creates_issue65_schema_and_indexes(self):
        ...
        self.assertIn("sbv_ratio FLOAT NULL", joined_sql)
        self.assertIn("flow5_mcap FLOAT NULL", joined_sql)
        self.assertIn("pbr_discount FLOAT NULL", joined_sql)
        self.assertIn("per_discount FLOAT NULL", joined_sql)
        self.assertIn("div_premium FLOAT NULL", joined_sql)
        self.assertIn("cheap_score FLOAT NULL", joined_sql)
        self.assertIn("cheap_score_version VARCHAR(80) NULL", joined_sql)
        self.assertIn("cheap_score_confidence FLOAT NULL", joined_sql)
        ...
        self.assertIn("adj_open DECIMAL(20, 5) NULL", joined_sql)
        self.assertIn("adj_high DECIMAL(20, 5) NULL", joined_sql)
        self.assertIn("adj_low DECIMAL(20, 5) NULL", joined_sql)
        ...
        self.assertIn("ALTER TABLE DailyStockPrice ADD COLUMN adj_open", joined_sql)
        self.assertIn("ALTER TABLE DailyStockPrice ADD COLUMN adj_high", joined_sql)
        self.assertIn("ALTER TABLE DailyStockPrice ADD COLUMN adj_low", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN sbv_ratio", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN flow5_mcap", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN pbr_discount", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN per_discount", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN div_premium", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN cheap_score", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN cheap_score_version", joined_sql)
        self.assertIn("ALTER TABLE DailyStockTier ADD COLUMN cheap_score_confidence", joined_sql)
